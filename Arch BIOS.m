...
# 📦 openvpn + wireguard — VPN-подключения через GUI NetworkManager
pacman -S --noconfirm openvpn networkmanager-openvpn wireguard-tools networkmanager-wireguard
# #------------------------------------------------------------------------------
...
# ШАГ 13: ШРИФТЫ
# #------------------------------------------------------------------------------
# 📝 Русская орфография для Firefox, Thunderbird, LibreOffice
pacman -S --noconfirm hunspell-ru hyphen-ru mythes-ru
